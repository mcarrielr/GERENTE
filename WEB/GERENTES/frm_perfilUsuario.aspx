<%@ Page Title="" Language="C#" MasterPageFile="~/NUO.Master" AutoEventWireup="true" CodeBehind="frm_perfilUsuario.aspx.cs" Inherits="GERENTES.frm_perfilUsuario" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server"> 
    ...
    <asp:Panel ID="pn_alerta" Width="100%" runat="server">
							...
							<!-- Header -->
								<header id="header">
									<a href="frm_usuario.aspx" class="logo"><strong>Mantenimiento de </strong>  <asp:Label ID="lbl_usuario"  runat="server"  Text="Perfiles de Usuario"></asp:Label></a>
									<%--<ul class="icons">
                 ...
                 <tr >
                     <td>
                         <asp:GridView ID="grid" runat="server" AllowPaging="true" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="3" 
                             ...
                             <Columns>
                                 <asp:BoundField DataField="CODIGO_PUS"  HeaderText="#. REGISTRO" ItemStyle-Width="20%" SortExpression="Name">
                                 <HeaderStyle HorizontalAlign="Center" />
                                 <ItemStyle HorizontalAlign="Center" />
                                 </asp:BoundField>
                                 <asp:BoundField DataField="DESCRIPCION_PUS" ItemStyle-HorizontalAlign="Right" HeaderText="DESCRIPCION" ItemStyle-Width="70%" SortExpression="Name">
                                 <HeaderStyle HorizontalAlign="Center" />
                                 <ItemStyle HorizontalAlign="Center" />
                                 </asp:BoundField>
        ...
        <center>
            ...
            <div style="float:left;">
                                     ...
                                     <div style="float:right;">
                                      ...
                                      Text="Guardar" OnClick="btnGuardar_Click" /></div>
            <br /><br /><br /><br />
          <table border="0"   style="width:80%; top: 10px; ">   
