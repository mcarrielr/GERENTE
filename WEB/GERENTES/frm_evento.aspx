<%@ Page Title="" Language="C#" MasterPageFile="~/NUO.Master" AutoEventWireup="true" CodeBehind="frm_evento.aspx.cs" Inherits="GERENTES.frm_evento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server"> 
    ...
    <asp:Panel ID="pn_alerta" Width="100%" runat="server">
							...
							<!-- Header -->
								<header id="header">
									<a href="frm_evento.aspx" class="logo"><strong>Mantenimiento de </strong>  <asp:Label ID="lbl_usuario"  runat="server"  Text="Eventos"></asp:Label></a>
									<%--<ul class="icons">
                 ...
                 <tr >
                     <td>
                         <asp:GridView ID="grid" runat="server" AllowPaging="true" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="3" 
                             ...
                             <Columns>
                                 <asp:BoundField DataField="CODIGO_EVE"  HeaderText="#. REGISTRO" ItemStyle-Width="20%" SortExpression="Name">
                                 <HeaderStyle HorizontalAlign="Center" />
                                 <ItemStyle HorizontalAlign="Center" />
                                 </asp:BoundField>
                                 <asp:BoundField DataField="DESCRIPCION_EVE" ItemStyle-HorizontalAlign="Right" HeaderText="DESCRIPCION" ItemStyle-Width="70%" SortExpression="Name">
                                 <HeaderStyle HorizontalAlign="Center" />
                                 <ItemStyle HorizontalAlign="Center" />
                                 </asp:BoundField>
