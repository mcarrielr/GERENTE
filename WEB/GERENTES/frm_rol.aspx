<%@ Page Title="" Language="C#" MasterPageFile="~/NUO.Master" AutoEventWireup="true" CodeBehind="frm_rol.aspx.cs" Inherits="GERENTES.frm_rol" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server"> 
    ...
    <asp:Panel ID="pn_alerta" Width="100%" runat="server">
							...
							<!-- Header -->
								<header id="header">
									<a href="frm_usuario.aspx" class="logo"><strong>Mantenimiento de </strong>  <asp:Label ID="lbl_usuario"  runat="server"  Text="Roles"></asp:Label></a>
									<%--<ul class="icons">
                 ...
                 <tr >
                     <td>
                         <asp:GridView ID="grid" runat="server" AllowPaging="true" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="3" 
                             ...
                             <Columns>
                                 <asp:BoundField DataField="CODIGO_ROL"  HeaderText="#. REGISTRO" ItemStyle-Width="20%" SortExpression="Name">
                                 <HeaderStyle HorizontalAlign="Center" />
                                 <ItemStyle HorizontalAlign="Center" />
                                 </asp:BoundField>
                                 <asp:BoundField DataField="DESCRIPCION_ROL" ItemStyle-HorizontalAlign="Right" HeaderText="DESCRIPCION" ItemStyle-Width="70%" SortExpression="Name">
                                 <HeaderStyle HorizontalAlign="Center" />
                                 <ItemStyle HorizontalAlign="Center" />
                                 </asp:BoundField>
          ...
          <table border="0"  style="width:80%; ">  
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button ID="btn_pagina" runat="server" CausesValidation="false" 
                                            Text="Asignar Página" OnClick="btn_pagina_Click"  /></td>
                </tr>
                </table>
           </center>
        </ContentTemplate>
        ...
        <asp:UpdatePanel ID="pan_pagina" runat="server">
        <ContentTemplate>
            <br />
        <div class="table-responsive">
        <asp:Button ID="btn_cerrarPagina" runat="server" CausesValidation="false" 
                                            CssClass="btn btn-primary" Text="Regresar" 
                                            onclick="btn_cerrarPagina_Click" />
            <h2>
                <asp:Label ID="lbl_rol" runat="server" Text=""></asp:Label>
            </h2>
          <table class="table-wrapper" >   
                    <tr>
                        <td style="width:45%" align="center">
                            <asp:Label ID="Label3" runat="server" 
                                Text="Páginas no pertenecientes al Rol"></asp:Label>
                        </td>
                        <td style="width:10%">
                            &nbsp;</td>
                        <td style="width:45%" align="center">
                            <asp:Label ID="Label5" runat="server" Text="Páginas pertenecientes al Rol"></asp:Label>
                        </td>
                </tr>
                    <tr>
                        <td >
